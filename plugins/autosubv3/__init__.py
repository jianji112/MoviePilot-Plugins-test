...
class AutoSubv3(_PluginBase):
    ...
    def init_plugin(self, config=None):
        ...
        logger.info("[AutoSubv3 Debug] DEBUG_MARKER_20260330_2331_EARLY_SKIP")
    ...
    def load_skip_chinese_videos(self) -> dict:
        return self.get_data("skip_chinese_videos") or {}

    def save_skip_chinese_videos(self, skipped: dict):
    ...
    def get_form(self) -> Tuple[List[dict], Dict[str, Any]]:
        ...
        return [
            ...
            "openai_key": None,
            "openai_model": "inclusionAI/Ling-mini-2.0",
            "context_window": 5,
            "max_retries": 3,
            "enable_merge": False,
